...
const Svadista = () => {
  ...
  return (
    <div className="min-h-screen" style={{ backgroundColor: '#FDFBF7' }}>
      ...
      {/* Sticky Filter */}
      <div className="sticky top-[calc(36px+4rem)] md:top-[calc(36px+5rem)] z-30 py-3 px-4 md:px-8" style={{ backgroundColor: '#FDF5E6', borderBottom: '1px solid rgba(139,58,58,0.15)', boxShadow: '0 2px 8px rgba(0,0,0,0.04)' }} data-testid="svadista-filters">
