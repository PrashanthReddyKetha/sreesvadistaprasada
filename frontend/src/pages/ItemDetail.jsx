...
const MiniCard = ({ item }) => {
  ...
  return (
    <Link to={`/item/${item.id}`} className="flex-shrink-0 w-44 rounded-xl overflow-hidden bg-white shadow-sm hover:shadow-md transition-shadow" style={{ border:'1px solid rgba(244,196,48,0.2)' }}>
      {item.image ? (
