      ...
      <section className="pt-[calc(32px+4rem)] md:pt-[calc(32px+5rem)] relative overflow-hidden" style={{ height: 'min(50vh, 420px)' }}>
        ...
        <div className="relative h-full max-w-7xl mx-auto px-4 md:px-8 flex items-center">
          <div className="max-w-xl">
            ...
            <p className="text-lg text-blue-100 leading-relaxed mb-1">Burgers, wraps and quick bites.</p>
            <p className="text-sm text-blue-200 leading-relaxed max-w-md">
              When you want something quick and satisfying — our street food selection has you covered.
            </p>
          </div>
        </div>
      </section>
                  ...
                  <div className="p-4">
                    <div className="flex items-start justify-between gap-2 mb-1.5">
                      <Link to={`/item/${dish.id}`}>
                        <h3 className="font-bold text-sm leading-snug hover:underline" style={{ color: '#1E3A8A' }}>{dish.name}</h3>
                      </Link>
