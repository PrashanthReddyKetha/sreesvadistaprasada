  ...
  return (
    <div className="min-h-screen" style={{ backgroundColor: '#FDFBF7' }}>
      ...
      <section className="pt-[calc(32px+4rem)] md:pt-[calc(32px+5rem)] relative overflow-hidden" style={{ height: 'min(50vh, 420px)' }}>
        <img
          src="https://images.unsplash.com/photo-1553909489-cd47e0907980?crop=entropy&cs=srgb&fm=jpg&q=85&w=1280"
          srcSet="https://images.unsplash.com/photo-1553909489-cd47e0907980?crop=entropy&cs=srgb&fm=jpg&q=85&w=640 640w, https://images.unsplash.com/photo-1553909489-cd47e0907980?crop=entropy&cs=srgb&fm=jpg&q=85&w=1280 1280w"
          sizes="100vw"
          alt="Traditional Indian drinks and mango lassi delivery Milton Keynes — Sree Svadista Prasada"
