        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-12">
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li>
                <Link to="/story" className="text-gray-300 hover:text-white text-sm transition-colors duration-200">
                  Our Story
                </Link>
              </li>
              <li>
                <Link to="/menu" className="text-gray-300 hover:text-white text-sm transition-colors duration-200">
                  Full Menu
                </Link>
              </li>
              <li>
                <Link to="/subscriptions" className="text-gray-300 hover:text-white text-sm transition-colors duration-200">
                  Subscription Plans
                </Link>
              </li>
              <li>
                <Link to="/catering" className="text-gray-300 hover:text-white text-sm transition-colors duration-200">
                  Catering Services
                </Link>
              </li>
              <li>
          ...
          <div>
            ...
            <div className="space-y-3">
              ...
              <div className="flex items-center space-x-3">
                ...
                <p className="text-sm text-gray-300">info@sreesvadista.co.uk</p>
              </div>
            </div>
