  ...
  return (
    <div className="min-h-screen" style={{ backgroundColor: '#FDFBF7' }}>
      ...
      <section className="pt-[calc(32px+4rem)] md:pt-[calc(32px+5rem)] relative overflow-hidden" style={{ height: 'min(45vh, 360px)' }}>
        <Image fill priority sizes="100vw" src="https://images.unsplash.com/photo-1742281258189-3b933879867a?crop=entropy&cs=srgb&fm=jpg&auto=format&q=60&w=1920" alt="Our Full Menu" className="object-cover" />
