...
export const metadata = {
  ...
  description: 'Authentic South Indian food delivery in Milton Keynes — Wolverton, Stony Stratford, Greenleys, Newport Pagnell, Bletchley, Westcroft, Central MK and all MK postcodes. Non-veg Svadista, pure veg Prasada, Dabba Wala subscriptions from £12.50/meal.',
