...
const Drinks = ({ initialItems = [] }) => {
  ...
  useEffect(() => { trackMenuCategoryView('drinks'); }, []);
  ...
  return (
    <div className="min-h-screen" style={{ backgroundColor: '#FDFBF7' }}>
      ...
      <section className="pt-[calc(32px+4rem)] md:pt-[calc(32px+5rem)] relative overflow-hidden" style={{ height: 'min(50vh, 420px)' }}>
        <Image fill priority sizes="100vw" src="https://images.unsplash.com/photo-1553909489-cd47e0907980?crop=entropy&cs=srgb&fm=jpg&auto=format&q=60&w=1920" alt="Drinks" className="object-cover" />
        ...
        <div className="max-w-7xl mx-auto">
          ...
          {loading ? (
            ...
            <div className="grid sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
              {filtered.map(drink => (
                <Link key={drink.id} href={buildItemUrl(drink)} onClick={e => e.target.closest('button') && e.preventDefault()}>
