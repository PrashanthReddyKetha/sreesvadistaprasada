    ...
    return (
      <div className="min-h-screen" style={{ backgroundColor: C.cream }}>
        ...
        <div className="max-w-2xl mx-auto px-4 py-14">
          ...
          {/* Buttons */}
          <div className="flex flex-col sm:flex-row gap-3 justify-center">
            <Link href="/dashboard" className="px-8 py-3.5 text-sm font-semibold text-white rounded-sm text-center" style={{ backgroundColor: C.primary }}>
              Go to my dashboard
            </Link>
            <Link href="/" className="px-8 py-3.5 text-sm font-semibold rounded-sm border-2 text-center" style={{ borderColor: C.primary, color: C.primary }}>
              Back to home
            </Link>
          </div>
        </div>
          ...
          <div className="max-w-7xl mx-auto w-full">
            <div className="max-w-xl">
              ...
              <div className="flex items-center gap-5 mt-5 flex-wrap">
                ...
                <a href="/subscriptions/about" className="text-sm font-medium text-white/70 hover:text-white underline underline-offset-2 transition-colors duration-150">
